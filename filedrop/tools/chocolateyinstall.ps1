...
$url        = 'http://commondatastorage.googleapis.com/filedropme/Filedrop.exe' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'filedrop*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
