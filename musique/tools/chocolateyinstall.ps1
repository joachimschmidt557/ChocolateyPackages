...
$url        = 'http://flavio.tordini.org/files/musique/musique.exe' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'musique*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
