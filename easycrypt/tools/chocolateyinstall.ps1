...
$url        = 'http://quadsoft.org/download/easyCryptSetup.exe' # download url, HTTPS preferred
$url64      = 'http://quadsoft.org/download/easyCryptSetup.exe' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
...
$packageArgs = @{
  ...
  softwareName  = 'easycrypt*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
